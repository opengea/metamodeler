...
<head>
    ...
    <title>Three.js Toroides amb Gradient i Transparència</title>
    <style>
        body { margin: 0; }
...
<body>
    <div id="controls">
        ...
        <input type="number" id="radialSegments" value="16" min="3"><br><br>
    ...
    <script>
        ...
        function createTorusScene() {
            ...
            for (let i = 0; i < torusCount; i++) {
                ...
                // Disposició esfèrica dels forats
                const phi = (i / torusCount) * Math.PI; // Dividim el rang polar
                const theta = (i / torusCount) * 2 * Math.PI; // Distribuïm en el rang azimutal
                ...
                // Rotació del torus per alinear els forats en la superfície esfèrica
                torus.rotation.x = phi;
                torus.rotation.z = theta;
                toruses.push(torus);
                scene.add(torus);
            }
        }
